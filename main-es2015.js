...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"chat-container\" *ngIf=\"authService.userData.id\">\n  <app-header></app-header>\n  <div class=\"chat-main\">\n    <app-chat-lists></app-chat-lists>\n    <app-chat-messages></app-chat-messages>\n  </div>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"profile-info-container\">\n  <button mat-menu-item (click)=\"logout()\">\n    <mat-icon>exit_to_app</mat-icon>\n    <span>Log out</span>\n  </button>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-modal-header [data]=\"{title: data.type}\" (closeDialog)=\"closeModal()\"></app-modal-header>\n<app-select-users [type]=\"data.type\" [users]=\"users\" [usersFilter]=\"usersFilter\" (selectUser)=\"selectUser($event)\"></app-select-users>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<input type=\"text\" class=\"input-search\" placeholder=\"Search\" (input)=\"search($event.target.value)\">\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<img *ngIf=\"avatarUrl\" [ngClass]=\"{'header-avatar': type !== 'chat'}\" [src]=\"avatarUrl\" class=\"avatar\" alt=\"avatar\">\n<div *ngIf=\"!avatarUrl\" [ngClass]=\"{'header-avatar': type !== 'chat'}\" class=\"avatar\"><span>{{chatName ? chatName[0] : 'T' | uppercase}}</span></div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"single-user\" [ngClass]=\"{'selected': user.selected, 'blurred': user.blurred}\">\n  <app-user-avatar [chatName]=\"user.username\" [avatarUrl]=\"user.avatar\" [type]=\"'chat'\"></app-user-avatar>\n  <div class=\"username-container\">\n    <span class=\"username\">{{user.username}}</span>\n  </div>\n</div>\n");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OPEN_CHAT", function() { return OPEN_CHAT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UPDATE_CHAT_INFO", function() { return UPDATE_CHAT_INFO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLOSE_NEW_CHAT_MODAL", function() { return CLOSE_NEW_CHAT_MODAL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLOSE_CHAT_SETTINGS_MODAL", function() { return CLOSE_CHAT_SETTINGS_MODAL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CREATE_NEW_CHAT", function() { return CREATE_NEW_CHAT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_NEW_CHAT", function() { return ADD_NEW_CHAT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_MEMBERS", function() { return ADD_MEMBERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UPDATE_MEMBERS", function() { return UPDATE_MEMBERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLEAR_SELECT_MESSAGE", function() { return CLEAR_SELECT_MESSAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UPDATE_CHAT_MESSAGE", function() { return UPDATE_CHAT_MESSAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SHOW_CHAT_ICON", function() { return SHOW_CHAT_ICON; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_INFO_ERROR", function() { return EDIT_INFO_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SCROLL_DOWN", function() { return SCROLL_DOWN; });
...
/* harmony import */ var _components_chat_main_chat_main_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/chat-main/chat-main.component */ "./src/app/components/chat-main/chat-main.component.ts");
...
const routes = [
    { path: '', component: _components_chat_main_chat_main_component__WEBPACK_IMPORTED_MODULE_6__["ChatMainComponent"], canActivate: [_guards_authentication_guard__WEBPACK_IMPORTED_MODULE_3__["AuthenticationGuard"]] },
...
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
...
/* harmony import */ var ngx_material_file_input__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-material-file-input */ "./node_modules/ngx-material-file-input/fesm2015/ngx-material-file-input.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./interceptors/auth.interceptor */ "./src/app/interceptors/auth.interceptor.ts");
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/fesm2015/ngx-cookie-service.js");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
...
/* harmony import */ var _components_chat_main_chat_lists_chat_lists_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/chat-main/chat-lists/chat-lists.component */ "./src/app/components/chat-main/chat-lists/chat-lists.component.ts");
/* harmony import */ var _components_chat_main_chat_main_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/chat-main/chat-main.component */ "./src/app/components/chat-main/chat-main.component.ts");
/* harmony import */ var _components_chat_main_chat_messages_chat_messages_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/chat-main/chat-messages/chat-messages.component */ "./src/app/components/chat-main/chat-messages/chat-messages.component.ts");
/* harmony import */ var _components_chat_main_chat_lists_chat_preview_chat_preview_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/chat-main/chat-lists/chat-preview/chat-preview.component */ "./src/app/components/chat-main/chat-lists/chat-preview/chat-preview.component.ts");
...
/* harmony import */ var _components_modals_header_info_header_info_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/modals/header-info/header-info.component */ "./src/app/components/modals/header-info/header-info.component.ts");
/* harmony import */ var _components_modals_chat_information_profile_settings_profile_settings_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/modals/chat-information/profile-settings/profile-settings.component */ "./src/app/components/modals/chat-information/profile-settings/profile-settings.component.ts");
/* harmony import */ var _components_header_menu_menu_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/header/menu/menu.component */ "./src/app/components/header/menu/menu.component.ts");
/* harmony import */ var _components_modals_chat_information_chat_settings_chat_settings_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/modals/chat-information/chat-settings/chat-settings.component */ "./src/app/components/modals/chat-information/chat-settings/chat-settings.component.ts");
/* harmony import */ var _components_user_avatar_user_avatar_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/user-avatar/user-avatar.component */ "./src/app/components/user-avatar/user-avatar.component.ts");
/* harmony import */ var _components_modals_modals_header_modal_header_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/modals/modals-header/modal-header.component */ "./src/app/components/modals/modals-header/modal-header.component.ts");
/* harmony import */ var _components_chat_main_chat_messages_editor_editor_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/chat-main/chat-messages/editor/editor.component */ "./src/app/components/chat-main/chat-messages/editor/editor.component.ts");
/* harmony import */ var _components_modals_new_chat_new_chat_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/modals/new-chat/new-chat.component */ "./src/app/components/modals/new-chat/new-chat.component.ts");
/* harmony import */ var _components_modals_new_chat_select_users_select_users_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/modals/new-chat/select-users/select-users.component */ "./src/app/components/modals/new-chat/select-users/select-users.component.ts");
/* harmony import */ var _components_users_list_users_list_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/users-list/users-list.component */ "./src/app/components/users-list/users-list.component.ts");
/* harmony import */ var _components_users_list_user_user_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/users-list/user/user.component */ "./src/app/components/users-list/user/user.component.ts");
/* harmony import */ var _components_modals_new_chat_new_chat_footer_new_chat_footer_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/modals/new-chat/new-chat-footer/new-chat-footer.component */ "./src/app/components/modals/new-chat/new-chat-footer/new-chat-footer.component.ts");
/* harmony import */ var _components_modals_edit_name_edit_name_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/modals/edit-name/edit-name.component */ "./src/app/components/modals/edit-name/edit-name.component.ts");
/* harmony import */ var _components_chat_main_chat_messages_messages_list_messages_list_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./components/chat-main/chat-messages/messages-list/messages-list.component */ "./src/app/components/chat-main/chat-messages/messages-list/messages-list.component.ts");
/* harmony import */ var _components_chat_main_chat_messages_messages_list_message_message_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./components/chat-main/chat-messages/messages-list/message/message.component */ "./src/app/components/chat-main/chat-messages/messages-list/message/message.component.ts");
/* harmony import */ var _components_search_search_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./components/search/search.component */ "./src/app/components/search/search.component.ts");
/* harmony import */ var _components_modals_chat_information_contact_settings_contact_settings_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./components/modals/chat-information/contact-settings/contact-settings.component */ "./src/app/components/modals/chat-information/contact-settings/contact-settings.component.ts");
/* harmony import */ var _components_modals_chat_information_chanel_settings_chanel_settings_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./components/modals/chat-information/chanel-settings/chanel-settings.component */ "./src/app/components/modals/chat-information/chanel-settings/chanel-settings.component.ts");
/* harmony import */ var _components_modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./components/modals/chat-information/chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _components_chat_main_chat_messages_message_select_message_select_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./components/chat-main/chat-messages/message-select/message-select.component */ "./src/app/components/chat-main/chat-messages/message-select/message-select.component.ts");
/* harmony import */ var _components_modals_message_modal_message_modal_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./components/modals/message-modal/message-modal.component */ "./src/app/components/modals/message-modal/message-modal.component.ts");
/* harmony import */ var _components_modals_user_contacts_new_contact_new_contact_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./components/modals/user-contacts/new-contact/new-contact.component */ "./src/app/components/modals/user-contacts/new-contact/new-contact.component.ts");
/* harmony import */ var _components_modals_user_contacts_user_contacts_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./components/modals/user-contacts/user-contacts.component */ "./src/app/components/modals/user-contacts/user-contacts.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_chat_main_chat_lists_chat_lists_component__WEBPACK_IMPORTED_MODULE_17__["ChatListsComponent"],
            _components_chat_main_chat_main_component__WEBPACK_IMPORTED_MODULE_18__["ChatMainComponent"],
            _components_chat_main_chat_messages_chat_messages_component__WEBPACK_IMPORTED_MODULE_19__["ChatMessagesComponent"],
            _components_chat_main_chat_lists_chat_preview_chat_preview_component__WEBPACK_IMPORTED_MODULE_20__["ChatPreviewComponent"],
            _components_header_header_component__WEBPACK_IMPORTED_MODULE_21__["HeaderComponent"],
            _components_header_menu_menu_component__WEBPACK_IMPORTED_MODULE_24__["MenuComponent"],
            _components_modals_header_info_header_info_component__WEBPACK_IMPORTED_MODULE_22__["HeaderInfoComponent"],
            _components_modals_chat_information_profile_settings_profile_settings_component__WEBPACK_IMPORTED_MODULE_23__["ProfileSettingsComponent"],
            ...
            _components_user_avatar_user_avatar_component__WEBPACK_IMPORTED_MODULE_26__["UserAvatarComponent"],
            _components_modals_modals_header_modal_header_component__WEBPACK_IMPORTED_MODULE_27__["ModalHeaderComponent"],
            _components_chat_main_chat_messages_editor_editor_component__WEBPACK_IMPORTED_MODULE_28__["EditorComponent"],
            _components_modals_new_chat_new_chat_component__WEBPACK_IMPORTED_MODULE_29__["NewChatComponent"],
            _components_modals_new_chat_select_users_select_users_component__WEBPACK_IMPORTED_MODULE_30__["SelectUsersComponent"],
            _components_users_list_users_list_component__WEBPACK_IMPORTED_MODULE_31__["UsersListComponent"],
            _components_users_list_user_user_component__WEBPACK_IMPORTED_MODULE_32__["UserComponent"],
            _components_modals_new_chat_new_chat_footer_new_chat_footer_component__WEBPACK_IMPORTED_MODULE_33__["NewChatFooterComponent"],
            _components_modals_edit_name_edit_name_component__WEBPACK_IMPORTED_MODULE_34__["EditNameComponent"],
            _components_chat_main_chat_messages_messages_list_messages_list_component__WEBPACK_IMPORTED_MODULE_35__["MessagesListComponent"],
            _components_chat_main_chat_messages_messages_list_message_message_component__WEBPACK_IMPORTED_MODULE_36__["MessageComponent"],
            _components_search_search_component__WEBPACK_IMPORTED_MODULE_37__["SearchComponent"],
            _components_modals_chat_information_contact_settings_contact_settings_component__WEBPACK_IMPORTED_MODULE_38__["ContactSettingsComponent"],
            _components_modals_chat_information_chanel_settings_chanel_settings_component__WEBPACK_IMPORTED_MODULE_39__["ChanelSettingsComponent"],
            _components_modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_40__["ChatInformationComponent"],
            _components_chat_main_chat_messages_message_select_message_select_component__WEBPACK_IMPORTED_MODULE_41__["MessageSelectComponent"],
            ...
            _components_modals_user_contacts_user_contacts_component__WEBPACK_IMPORTED_MODULE_44__["UserContactsComponent"]
        ],
        imports: [
        ...
        providers: [
            ...
            _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_13__["BusService"],
            {
...
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
...
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
let ChatListsComponent = class ChatListsComponent {
    ...
    addNewChat(chat) {
        ...
        this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_7__["SELECT_CHAT"], { chatId: chat._id, updateChatInfo: true });
    }
    ...
    openChat(data) {
        if (data.isDialog) {
            ...
            if (dialog) {
                ...
                this.chatService.createChat('', _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_8__["ChatTypes"].DIALOG, '', [data.chatId])
                    .subscribe(res => this.addNewChat(res.chat));
                return;
            }
        }
        this.selectedChatId = data.chatId;
        this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_7__["SELECT_CHAT"], { chatId: data.chatId, updateChatInfo: true });
    }
...
ChatListsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-chat-lists',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-lists.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-lists/chat-lists.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-lists.style.scss */ "./src/app/components/chat-main/chat-lists/chat-lists.style.scss")).default]
    })
], ChatListsComponent);
...
], ChatPreviewComponent.prototype, "activeUser", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChatPreviewComponent.prototype, "chat", void 0);
ChatPreviewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-chat-preview',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-preview.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-lists/chat-preview/chat-preview.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-preview.style.scss */ "./src/app/components/chat-main/chat-lists/chat-preview/chat-preview.style.scss")).default]
    })
...
ChatMainComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-main.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-main.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-main.style.scss */ "./src/app/components/chat-main/chat-main.style.scss")).default]
    })
], ChatMainComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
...
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _scroll_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scroll.model */ "./src/app/components/chat-main/chat-messages/scroll.model.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
let ChatMessagesComponent = class ChatMessagesComponent {
    ...
    setShowEditorSettings() {
        this.showEditor = !(this.chatService.activeChat.chatType === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_9__["ChatTypes"].CHANNEL &&
    ...
    addMembers(data) {
        if (this.chatService.activeChat._id === data.chatId) {
            this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_8__["UPDATE_MEMBERS"], { action: 'add', users: data.users });
    ...
    removeMembers(data) {
        if (this.authService.userData.id !== data.userId && this.chatService.activeChat._id === data.chatId) {
            this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_8__["UPDATE_MEMBERS"], { action: 'delete', userId: data.userId });
...
ChatMessagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-messages.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-messages/chat-messages.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-messages.style.scss */ "./src/app/components/chat-main/chat-messages/chat-messages.style.scss")).default]
    })
...
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../modals/chat-information/chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
/* harmony import */ var _models_socket_message_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../models/socket.message.model */ "./src/app/models/socket.message.model.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../actions/main.action */ "./src/app/actions/main.action.ts");
    ...
    openModal(type) {
        this.dialog.open(_modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_7__["ChatInformationComponent"], {
            ...
            data: new _models_chat_information_model__WEBPACK_IMPORTED_MODULE_8__["ChatInformationModel"](type === 'profile' ? _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_10__["ChatTypes"].PROFILE : this.chatService.activeChat.chatType, type === 'profile' || (this.chatService.activeChat.admins.includes(this.authService.userData.id)
                && this.chatService.activeChat.chatType !== _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_10__["ChatTypes"].DIALOG), type === 'profile' ? this.authService.userData.id
                : this.chatService.activeChat.chatType === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_10__["ChatTypes"].DIALOG
...
EditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-editor',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./editor.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-messages/editor/editor.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./editor.style.scss */ "./src/app/components/chat-main/chat-messages/editor/editor.style.scss")).default]
    })
], EditorComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageSelectComponent", function() { return MessageSelectComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _modals_message_modal_message_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../modals/message-modal/message-modal.component */ "./src/app/components/modals/message-modal/message-modal.component.ts");
/* harmony import */ var _modals_message_modal_message_modal_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../modals/message-modal/message-modal.model */ "./src/app/components/modals/message-modal/message-modal.model.ts");
/* harmony import */ var _models_socket_message_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../models/socket.message.model */ "./src/app/models/socket.message.model.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../actions/main.action */ "./src/app/actions/main.action.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], MessageSelectComponent.prototype, "messages", void 0);
MessageSelectComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-message-select',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./message-select.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-messages/message-select/message-select.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./message-select.style.scss */ "./src/app/components/chat-main/chat-messages/message-select/message-select.style.scss")).default]
    })
...
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../modals/chat-information/chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
/* harmony import */ var _services_interfaces_message_types_interfaces__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../services/interfaces/message-types.interfaces */ "./src/app/services/interfaces/message-types.interfaces.ts");
...
let MessageComponent = class MessageComponent {
    ...
    openProfile(event) {
        ...
        const data = this.authService.userData.id === this.message.user._id ?
            new _models_chat_information_model__WEBPACK_IMPORTED_MODULE_5__["ChatInformationModel"](_services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_6__["ChatTypes"].PROFILE, true, this.authService.userData.id) :
            new _models_chat_information_model__WEBPACK_IMPORTED_MODULE_5__["ChatInformationModel"](_services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_6__["ChatTypes"].DIALOG, false, this.message.user._id);
...
MessageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./message.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-messages/messages-list/message/message.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./message.style.scss */ "./src/app/components/chat-main/chat-messages/messages-list/message/message.style.scss")).default]
    })
], MessageComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_interfaces_message_types_interfaces__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../services/interfaces/message-types.interfaces */ "./src/app/services/interfaces/message-types.interfaces.ts");
...
], MessagesListComponent.prototype, "selectMessage", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], MessagesListComponent.prototype, "scrollMessages", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
MessagesListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./messages-list.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chat-main/chat-messages/messages-list/messages-list.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./messages-list.style.scss */ "./src/app/components/chat-main/chat-messages/messages-list/messages-list.style.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScrollModel", function() { return ScrollModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modals/chat-information/chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
    ...
    openChatSetting() {
        if (this.chatService.activeChat._id) {
            this.dialog.open(_modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_3__["ChatInformationComponent"], {
                width: '450px',
                data: new _models_chat_information_model__WEBPACK_IMPORTED_MODULE_6__["ChatInformationModel"](this.chatService.activeChat.chatType, this.chatService.activeChat.chatType === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__["ChatTypes"].PROFILE
                    || (this.chatService.activeChat.admins.includes(this.authService.userData.id)
                        && this.chatService.activeChat.chatType !== _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__["ChatTypes"].DIALOG), this.chatService.activeChat.chatType === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__["ChatTypes"].DIALOG
                    ? this.chatService.activeChat.recipientId
                    : this.chatService.activeChat._id)
            });
        }
...
HeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-header',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./header.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/header/header.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./header.style.scss */ "./src/app/components/header/header.style.scss")).default]
    })
], HeaderComponent);
...
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _modals_new_chat_new_chat_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../modals/new-chat/new-chat.component */ "./src/app/components/modals/new-chat/new-chat.component.ts");
/* harmony import */ var _modals_chat_information_chat_information_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../modals/chat-information/chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _modals_user_contacts_user_contacts_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../modals/user-contacts/user-contacts.component */ "./src/app/components/modals/user-contacts/user-contacts.component.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
...
MenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-menu',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./menu.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/header/menu/menu.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./menu.style.scss */ "./src/app/components/header/menu/menu.style.scss")).default]
    })
], MenuComponent);
...
/* harmony import */ var _services_enrcypt_decrypt_encrypt_decrypt_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/enrcypt-decrypt/encrypt-decrypt.service */ "./src/app/services/enrcypt-decrypt/encrypt-decrypt.service.ts");
/* harmony import */ var _login_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./login.model */ "./src/app/components/login/login.model.ts");
/* harmony import */ var _login_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./login.form */ "./src/app/components/login/login.form.ts");
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-login',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/login/login.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.style.scss */ "./src/app/components/login/login.style.scss")).default]
    })
], LoginComponent);
...
class LoginForm {
    ...
    createForm() {
        this.formGroup = this.formBuilder.group({
            username: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.model.username, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required] }),
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.model.password, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required] }),
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChanelSettingsComponent", function() { return ChanelSettingsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _message_modal_message_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../message-modal/message-modal.component */ "./src/app/components/modals/message-modal/message-modal.component.ts");
/* harmony import */ var _message_modal_message_modal_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../message-modal/message-modal.model */ "./src/app/components/modals/message-modal/message-modal.model.ts");
/* harmony import */ var _models_socket_message_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../models/socket.message.model */ "./src/app/models/socket.message.model.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChanelSettingsComponent.prototype, "editChat", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChanelSettingsComponent.prototype, "description", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChanelSettingsComponent.prototype, "chatUsers", void 0);
ChanelSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-chanel-settings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chanel-settings.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/chat-information/chanel-settings/chanel-settings.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chanel-settings.style.scss */ "./src/app/components/modals/chat-information/chanel-settings/chanel-settings.style.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatInformationComponent", function() { return ChatInformationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
...
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
ChatInformationComponent.ctorParameters = () => [
    ...
    { type: _models_chat_information_model__WEBPACK_IMPORTED_MODULE_7__["ChatInformationModel"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
ChatInformationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-chat-information',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-information.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/chat-information/chat-information.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-information.style.scss */ "./src/app/components/modals/chat-information/chat-information.style.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatSettingsComponent", function() { return ChatSettingsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _chat_information_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../chat-information.component */ "./src/app/components/modals/chat-information/chat-information.component.ts");
/* harmony import */ var _new_chat_new_chat_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../new-chat/new-chat.component */ "./src/app/components/modals/new-chat/new-chat.component.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
/* harmony import */ var _models_chat_information_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../models/chat-information.model */ "./src/app/models/chat-information.model.ts");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _models_socket_message_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../models/socket.message.model */ "./src/app/models/socket.message.model.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChatSettingsComponent.prototype, "editChat", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChatSettingsComponent.prototype, "chatUsers", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ChatSettingsComponent.prototype, "isChannel", void 0);
ChatSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-chat-settings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-settings.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/chat-information/chat-settings/chat-settings.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-settings.style.scss */ "./src/app/components/modals/chat-information/chat-settings/chat-settings.style.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactSettingsComponent", function() { return ContactSettingsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../actions/main.action */ "./src/app/actions/main.action.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactSettingsComponent.prototype, "contactId", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactSettingsComponent.prototype, "username", void 0);
ContactSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-contact-settings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./contact-settings.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/chat-information/contact-settings/contact-settings.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./contact-settings.style.scss */ "./src/app/components/modals/chat-information/contact-settings/contact-settings.style.scss")).default]
    })
...
ProfileSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-settings.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/chat-information/profile-settings/profile-settings.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-settings.style.scss */ "./src/app/components/modals/chat-information/profile-settings/profile-settings.style.scss")).default]
    })
...
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
EditNameComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-name',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-name.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/edit-name/edit-name.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-name.style.scss */ "./src/app/components/modals/edit-name/edit-name.style.scss")).default]
    }),
...
let HeaderInfoComponent = class HeaderInfoComponent {
    ...
    selectImage(event) {
        if (event.target.files && event.target.files[0]) {
            ...
            this.api.put({
                ...
                headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'x-file-name': event.target.files[0].name, 'Content-Type': event.target.files[0].type }),
    ...
    openChat() {
        if (this.data.chatId !== (this.data.type === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_9__["ChatTypes"].DIALOG ? this.chatService.activeChat.recipientId : this.chatService.activeChat._id)) {
            this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_8__["OPEN_CHAT"], { chatId: this.data.chatId, isDialog: this.data.type === _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_9__["ChatTypes"].DIALOG });
        }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], HeaderInfoComponent.prototype, "data", void 0);
HeaderInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-header-info',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./header-info.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/header-info/header-info.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./header-info.style.scss */ "./src/app/components/modals/header-info/header-info.style.scss")).default]
    })
], HeaderInfoComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _message_modal_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./message-modal.model */ "./src/app/components/modals/message-modal/message-modal.model.ts");
...
MessageModalComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: _message_modal_model__WEBPACK_IMPORTED_MODULE_3__["MessageModalModel"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
MessageModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-message-modal',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./message-modal.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/message-modal/message-modal.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./message-modal.style.scss */ "./src/app/components/modals/message-modal/message-modal.style.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageModalModel", function() { return MessageModalModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _edit_name_edit_name_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../edit-name/edit-name.component */ "./src/app/components/modals/edit-name/edit-name.component.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
let ModalHeaderComponent = class ModalHeaderComponent {
    ...
    save(name, description, dialog) {
        ...
        this.api.put({ url, body })
            .subscribe(() => {
            this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_6__["UPDATE_CHAT_INFO"], { name, description });
            dialog.close();
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ModalHeaderComponent.prototype, "data", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ModalHeaderComponent.prototype, "closeDialog", void 0);
ModalHeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-modal-header',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./modal-header.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/modals-header/modal-header.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./modal-header.style.scss */ "./src/app/components/modals/modals-header/modal-header.style.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewChatFooterComponent", function() { return NewChatFooterComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../actions/main.action */ "./src/app/actions/main.action.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], NewChatFooterComponent.prototype, "type", void 0);
NewChatFooterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-new-chat-footer',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-chat-footer.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/new-chat/new-chat-footer/new-chat-footer.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-chat-footer.style.scss */ "./src/app/components/modals/new-chat/new-chat-footer/new-chat-footer.style.scss")).default]
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _edit_name_edit_name_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../edit-name/edit-name.component */ "./src/app/components/modals/edit-name/edit-name.component.ts");
/* harmony import */ var _models_socket_message_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../models/socket.message.model */ "./src/app/models/socket.message.model.ts");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
/* harmony import */ var _actions_main_action__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../actions/main.action */ "./src/app/actions/main.action.ts");
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_chat_chat_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../services/chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _services_sockets_sockets_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../services/sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
...
NewChatComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-new-chat',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-chat.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/new-chat/new-chat.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-chat.style.scss */ "./src/app/components/modals/new-chat/new-chat.style.scss")).default]
    }),
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SelectUsersComponent.prototype, "type", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SelectUsersComponent.prototype, "users", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SelectUsersComponent.prototype, "usersFilter", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], SelectUsersComponent.prototype, "selectUser", void 0);
SelectUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-users',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./select-users.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/new-chat/select-users/select-users.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./select-users.style.scss */ "./src/app/components/modals/new-chat/select-users/select-users.style.scss")).default]
    })
...
NewContactComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-contact.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/user-contacts/new-contact/new-contact.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-contact.style.scss */ "./src/app/components/modals/user-contacts/new-contact/new-contact.style.scss")).default]
    }),
...
/* harmony import */ var _services_requests_requests_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _services_bus_bus_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/bus/bus.service */ "./src/app/services/bus/bus.service.ts");
/* harmony import */ var _new_contact_new_contact_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./new-contact/new-contact.component */ "./src/app/components/modals/user-contacts/new-contact/new-contact.component.ts");
...
let UserContactsComponent = class UserContactsComponent {
    ...
    selectUser(id) {
        this.bus.publish(_actions_main_action__WEBPACK_IMPORTED_MODULE_6__["OPEN_CHAT"], { chatId: id, isDialog: true });
        this.dialogRef.close();
    }
...
UserContactsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user-contacts',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-contacts.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modals/user-contacts/user-contacts.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-contacts.style.scss */ "./src/app/components/modals/user-contacts/user-contacts.style.scss")).default]
    }),
...
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/auth/auth.service */ "./src/app/services/auth/auth.service.ts");
/* harmony import */ var _services_enrcypt_decrypt_encrypt_decrypt_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/enrcypt-decrypt/encrypt-decrypt.service */ "./src/app/services/enrcypt-decrypt/encrypt-decrypt.service.ts");
/* harmony import */ var _registration_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./registration.model */ "./src/app/components/registration/registration.model.ts");
/* harmony import */ var _registration_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./registration.form */ "./src/app/components/registration/registration.form.ts");
...
RegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./registration.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/registration/registration.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./registration.style.scss */ "./src/app/components/registration/registration.style.scss")).default]
    })
...
class RegistrationForm {
    ...
    createForm() {
        this.formGroup = this.formBuilder.group({
            username: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.model.username, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required] }),
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.model.password, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/)] }),
            confirmPassword: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.model.confirmPassword, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required] })
        });
        this.formGroup.valueChanges.subscribe((data) => {
            this.model.username = data.username;
            this.model.password = data.password;
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], SearchComponent.prototype, "fieldToFilter", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], SearchComponent.prototype, "filterData", void 0);
SearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-search',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./search.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/search/search.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./search.style.scss */ "./src/app/components/search/search.style.scss")).default]
    })
], SearchComponent);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], UserAvatarComponent.prototype, "type", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], UserAvatarComponent.prototype, "avatarUrl", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], UserAvatarComponent.prototype, "chatName", void 0);
UserAvatarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user-avatar',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-avatar.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/user-avatar/user-avatar.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-avatar.style.scss */ "./src/app/components/user-avatar/user-avatar.style.scss")).default]
    })
], UserAvatarComponent);
...
UserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/users-list/user/user.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user.style.scss */ "./src/app/components/users-list/user/user.style.scss")).default]
    })
], UserComponent);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], UsersListComponent.prototype, "selectUser", void 0);
UsersListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-users-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./users-list.template.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/users-list/users-list.template.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./users-list.style.scss */ "./src/app/components/users-list/users-list.style.scss")).default]
    })
], UsersListComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActiveUserModel", function() { return ActiveUserModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatInformationModel", function() { return ChatInformationModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _services_interfaces_chat_types_interfaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/interfaces/chat-types.interfaces */ "./src/app/services/interfaces/chat-types.interfaces.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatPreviewModel", function() { return ChatPreviewModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SocketMessageModel", function() { return SocketMessageModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _requests_requests_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _chat_chat_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../chat/chat.service */ "./src/app/services/chat/chat.service.ts");
/* harmony import */ var _sockets_sockets_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _models_active_user_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../models/active-user.model */ "./src/app/models/active-user.model.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _requests_requests_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../requests/requests.service */ "./src/app/services/requests/requests.service.ts");
/* harmony import */ var _sockets_sockets_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../sockets/sockets.service */ "./src/app/services/sockets/sockets.service.ts");
/* harmony import */ var _models_chat_preview_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../models/chat-preview.model */ "./src/app/models/chat-preview.model.ts");
/* harmony import */ var _components_chat_main_chat_messages_scroll_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/chat-main/chat-messages/scroll.model */ "./src/app/components/chat-main/chat-messages/scroll.model.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatTypes", function() { return ChatTypes; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let RequestsService = class RequestsService {
    ...
    post(options) {
        return this.httpClient
            .post(this.apiUrl + options.url, options.body);
    }
    get(options) {
        return this.httpClient
            .get(this.apiUrl + options.url, { params: options.parameters });
    }
    put(options) {
        return this.httpClient
            .put(this.apiUrl + options.url, options.body, {
            headers: options.headers
        });
    }
    delete(options) {
        return this.httpClient
            .delete(this.apiUrl + options.url, { params: options.parameters });
    }
};
...
let SocketsService = class SocketsService {
    constructor() { }
    initSocket(userId) {
        this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_3__(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api}?userId=${userId}`, { transports: ['websocket'] });
    }
    send(message) {
...
module.exports = __webpack_require__(/*! /Users/rbilmakovskyi/bilmakovchik/chat-client/src/main.ts */"./src/main.ts");
